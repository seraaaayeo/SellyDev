...
"""autogenerated by genpy from zed_wrapper/start_object_detectionRequest.msg. Do not edit."""
import sys
...
class start_object_detectionRequest(genpy.Message):
  ...
  _type = "zed_wrapper/start_object_detectionRequest"
...
def _get_struct_f3B():
    ...
    return _struct_f3B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from zed_wrapper/start_object_detectionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class start_object_detectionResponse(genpy.Message):
  ...
  _type = "zed_wrapper/start_object_detectionResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class start_object_detection(object):
  _type          = 'zed_wrapper/start_object_detection'
