...
(cl:defmethod cl:initialize-instance :after ((m <start_object_detection-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start_object_detection-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<start_object_detection-request> is deprecated: use zed_wrapper-srv:start_object_detection-request instead.")))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <start_object_detection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:confidence-val is deprecated.  Use zed_wrapper-srv:confidence instead.")
  (confidence m))

(cl:ensure-generic-function 'tracking-val :lambda-list '(m))
(cl:defmethod tracking-val ((m <start_object_detection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:tracking-val is deprecated.  Use zed_wrapper-srv:tracking instead.")
  (tracking m))

(cl:ensure-generic-function 'people-val :lambda-list '(m))
(cl:defmethod people-val ((m <start_object_detection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:people-val is deprecated.  Use zed_wrapper-srv:people instead.")
  (people m))

(cl:ensure-generic-function 'vehicles-val :lambda-list '(m))
(cl:defmethod vehicles-val ((m <start_object_detection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:vehicles-val is deprecated.  Use zed_wrapper-srv:vehicles instead.")
  (vehicles m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<start_object_detection-request>)))
  ...
  "zed_wrapper/start_object_detectionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_object_detection-request)))
  "Returns string type for a service object of type 'start_object_detection-request"
  "zed_wrapper/start_object_detectionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <start_object_detection-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start_object_detection-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<start_object_detection-response> is deprecated: use zed_wrapper-srv:start_object_detection-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<start_object_detection-response>)))
  ...
  "zed_wrapper/start_object_detectionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_object_detection-response)))
  "Returns string type for a service object of type 'start_object_detection-response"
  "zed_wrapper/start_object_detectionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_object_detection)))
  ...
  "zed_wrapper/start_object_detection")